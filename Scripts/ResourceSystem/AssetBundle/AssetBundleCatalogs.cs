...
namespace TEDCore.AssetBundle
{
    public class AssetBundleCatalogs
    {
        ...
        public AssetBundleCatalogs(string text)
        {
            ...
            var splits = text.Split(separator, System.StringSplitOptions.RemoveEmptyEntries);
        ...
        {
            var catalogs = m_catalogs.Where(a => assetBundleNames.Contains(a.assetBundleName));
