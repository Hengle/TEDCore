...
namespace TEDCore.AssetBundle
{
    ...
    {
        [MenuItem("TEDCore/AssetBundles/AssetBundle Build Window", priority = 1)]
        private static void OpenWindow()
        {
            var window = (AssetBundleBuildWindow)GetWindow(typeof(AssetBundleBuildWindow), false, "AssetBundle Build Window");
            window.Show();
        }
        ...
        private void OnDrawBuildButton()
        {
            if (GUILayout.Button("Build"))
            {
                ...
                var compressionType = (CompressionType)m_compressionType;
